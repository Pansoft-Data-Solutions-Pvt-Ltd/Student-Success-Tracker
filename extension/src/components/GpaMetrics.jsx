...
const GpaMetrics = ({
  ...
  // For the current/latest term, academicStanding may not be available yet.
  // Fall back to the previous term's academic standing in that case.
  ...
  return (
    <div className="gpa-cards-column">
      <div style={{ display: "flex", gap: "20px" }}>
        ...
        <Card className="term-attendance-card">
          <div className="gpa-left">
            ...
            >
              {/* Show a hint when falling back to previous term's standing */}
          ...
          <div
            ...
            style={{
              ...
              fontSize: displayedAcademicStanding
      ...
      <div style={{ display: "flex", flexDirection: "row", gap: "10px" }}>
        ...
        {/* Get AI Recommendation Button - only for latest term */}
        {isLatestTerm && (
