    ...
    <div className="gpa-cards-column">
      <div style={{ display: "flex", gap: "20px" }}>
          ...
          <div className="gpa-left">
            ...
            {!isFirstTerm && (
              <div className="gpa-delta-row">
                {isZeroDelta ? (
                  <Typography className="gpa-delta-text" style={{ fontWeight: 500 }}>
        ...
        <Card className="term-gpa-card">
          <div className="gpa-left">
            <Typography
              variant="p"
              style={{ fontSize: "1.05rem", fontWeight: 700, color: "#0369A1" }}
            >
              Term GPA
            </Typography>
            <Typography
              variant="body2"
              style={{ fontSize: "0.875rem", color: "#0C4A6E", marginTop: "10px", fontWeight: 500 }}
            >
          ...
          <div
            className="gpa-circle"
            style={{ borderColor: termGpaCircleColor, color: termGpaCircleColor }}
          >
            {loadingTermInformation
              ? "..."
        ...
        <Card className="term-attendance-card">
          <div className="gpa-left">
            <Typography
              variant="p"
              style={{ fontSize: "1.05rem", fontWeight: 700, color: "#06465f" }}
            >
              Academic Standing
            </Typography>
            <Typography
              variant="body2"
              style={{ fontSize: "0.875rem", color: "#065F46", marginTop: "10px", fontWeight: 500 }}
            >
          ...
          <div
            className="gpa-circle"
            style={{
              borderColor: academicStandingColor,
              color: academicStandingColor,
              fontSize: academicStanding
                ? academicStanding.length > 10
                  ? "0.75rem"
                  : academicStanding.length > 5
                    ? "0.80rem"
                    : undefined
                : undefined,
          ...
          >
            {loadingTermInformation ? "..." : academicStanding || "N/A"}
          </div>
        </Card>

        {/* PROGRAM GPA CARD — same class as Cumulative GPA */}
        <Card className="gpa-top-card">
          <div className="gpa-left">
            <Typography
              variant="p"
              style={{ fontSize: "1.05rem", fontWeight: 700, color: "#6B21A8" }}
            >
              Program GPA
            </Typography>
            <Typography
          ...
          <div
            className="gpa-circle"
            style={{
              borderColor: programGpaCircleColor,
      ...
      <div style={{ display: "flex", flexDirection: "row", gap: "10px" }}>
        <div className="legends-container" style={{ width: "58%" }}>
          ...
          <div style={{ display: "flex", gap: "10px" }}>
            <Typography variant="body2" style={{ fontWeight: 500, color: "#1F2937", whiteSpace: "nowrap" }}>
              A, B, C, D = Letter Grades
            </Typography>
            <Typography variant="body2" style={{ fontWeight: 500, color: "#1F2937", whiteSpace: "nowrap" }}>
              F = Fail
            </Typography>
            <Typography variant="body2" style={{ fontWeight: 500, color: "#03060c", whiteSpace: "nowrap" }}>
              N/A = Not Applicable
            </Typography>
          </div>
        </div>

        {/* Target GPA Button - only visible for latest term */}
        {isLatestTerm && (
