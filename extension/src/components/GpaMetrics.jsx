...
const GpaMetrics = ({
  ...
  return (
    <div className="gpa-cards-column">
      <div style={{ display: "flex", gap: "20px" }}>
        ...
        <Card className="term-attendance-card">
          <div className="gpa-left">
            <Typography
              variant="p"
              style={{ fontSize: "1.05rem", fontWeight: 700, color: "#065F46" }}
            >
              Academic Standing
            </Typography>
            <Typography
          ...
          <div
            ...
            style={{
              ...
              fontSize: academicStanding && academicStanding.length > 5 ? "0.65rem" : undefined,
            }}
          >
        ...
        <Card className="term-attendance-card">
          <div className="gpa-left">
            ...
            <Typography
              variant="body2"
              style={{ fontSize: "0.875rem", color: "#6B21A8", marginTop: "10px", fontWeight: 500 }}
            >
          ...
          <div
            className="gpa-circle"
            style={{ borderColor: programGpaCircleColor, color: programGpaCircleColor }}
          >
            {loadingTermInformation
              ? "..."
      ...
      <div
        style={{ display: "flex", flexDirection: "row", gap: "10px", justifyContent: "" }}
      >
